#!/usr/bin/env python3
"""Single-model AdvBench evaluation: llama_dpo_beta0.05"""
...
# Configuration
MODEL_NAME = "llama_dpo_beta0.05"
ADAPTER_PATH = "/ibex/scratch/zahrmm0b/safety-overrefusal-project/checkpoints/llama3.1_8b_dpo_pku_strict_beta0.05"
