#!/usr/bin/env python3
"""Single-model AdvBench evaluation: qwen_dpo_beta0.01"""
...
# Configuration
MODEL_NAME = "qwen_dpo_beta0.01"
ADAPTER_PATH = "/ibex/scratch/zahrmm0b/safety-overrefusal-project/checkpoints/qwen2.5_7b_dpo_pku_strict_beta0.01"
