#!/usr/bin/env python3
"""Single-model AdvBench evaluation: llama_dpo_beta1.0"""
...
# Configuration
MODEL_NAME = "llama_dpo_beta1.0"
ADAPTER_PATH = "/ibex/scratch/zahrmm0b/safety-overrefusal-project/checkpoints/llama3.1_8b_dpo_pku_strict_beta1.0"
